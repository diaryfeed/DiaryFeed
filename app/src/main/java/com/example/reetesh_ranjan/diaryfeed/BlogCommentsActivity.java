...
import com.example.reetesh_ranjan.diaryfeed.adapter.CommentRecyclerAdapter;
...
public class BlogCommentsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        commentsRecyclerAdapter=new CommentRecyclerAdapter(commentsList);
        comment_list.setHasFixedSize(true);
        comment_list.setLayoutManager(new LinearLayoutManager(this));
        comment_list.setAdapter(commentsRecyclerAdapter);

        firebaseFirestore.collection("posts/" + blog_post_id + "/Comments")
                .addSnapshotListener(BlogCommentsActivity.this, new EventListener<QuerySnapshot>() {
                    @Override
                ...
                firebaseFirestore.collection("posts/" + blog_post_id + "/Comments").add(commentsMap).addOnCompleteListener(new OnCompleteListener<DocumentReference>() {
                    ...
                    public void onComplete(@NonNull Task<DocumentReference> task) {
                        ...
                        if(!task.isSuccessful()){
                            ...
                            Toast.makeText(BlogCommentsActivity.this, "Error Posting Comment : " + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
